...
ПРАВИЛА ОТВЕТА:
Свои ответы расписывай в вёрстке Markdown, то есть используй символы # для заголовков и подзаголовков и другие маркеры Markdown.
Не забывай ставить абзацы где необходимо, желательно символом.
